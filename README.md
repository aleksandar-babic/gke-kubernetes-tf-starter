...
| <a name="input_gke_initial_node_count"></a> [gke\_initial\_node\_count](#input\_gke\_initial\_node\_count) | Number of the cluster nodes deployed initially in default node pool. | `number` | `0` | no |
